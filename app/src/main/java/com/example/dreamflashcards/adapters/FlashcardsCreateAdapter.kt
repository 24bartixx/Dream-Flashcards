...
class FlashcardsCreateAdapter(private val flashcardsFunctions: (Flashcard, String) -> Unit): ListAdapter<Flashcard, FlashcardsCreateAdapter.FlashcardViewHolder>(DiffCallback){
